			  ...
			  <form action="" id="form_e11" method="POST" target ="hidden_iframe11" onsubmit=" submitted=true;"> 
					<div class="wow fadeIn bbackg"> 
							 ...
							 <section  id="main_intro" class="backg" style="text-align: center;" >
								  ...
								  <img src="./img/ezgif-frame-041.jpg" class="bg-img br50" id="intro_size">
								 
								  <video id="vid" class="video br50 msize" autoplay muted playsinline loop style="z-index:1;">
								  <source id="hvid" src="./img/intro-video3.mp4" type="video/mp4">
								  </video> 
								  ...
								  <div class="container">
									<div class="row">
									  <div class="col-lg-6 col-md-6">
										<div class="about-img">
										  <img src="./img/model.jpg" style="width:96%" alt="" />
										</div>
									  </div>
							  ...
							  <div class="container">
								...
								<div class="row">
								  ...
								  <div class="col-lg-12 col-md-12 wow fadeInUp">
									<div class="member">
									  <img src="./img/ezgif-frame-041.jpg" class="img-fluid" alt="" style="max-height:460px;width:100%;object-fit:cover;margin-bottom:40px">
