...
<div class="inner">
    ...
    <h1 class="form-top-title">이메일을 통해 무료 온라인 검사를 받으세요</h1>
                   ...
                   <!-- <tr>
                    ...
                    <tr>
                        <td colspan="2" style="border-bottom: none"> 
                            ...
                            <input class="submit-btn" type='submit' id='send_message' value='무료 온라인 검사 받기' disabled >
    ...
    <div class="box_02_1">
        <div style="position:relative;height:150px;overflow:hidden;">
            <div id="ticker_wrap" style="position: absolute;top:0px;right:0px;width:100%;">
                ...
                <tbody>
                    <tr>
                        <td class="tg-0lax"><span class="submit_02">무료 설문 후기</span></td>
