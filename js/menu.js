...
<nav class="top">
    ...
    <img id ="logo_img" src="./img/sleep-logo.png" onclick="window.location.href='./index.html'">
      <!-- <p class="logo-font" id="lgt" style="" onclick="window.location.href='./index.html'">SLEEP & DIET</p> -->
