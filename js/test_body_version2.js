		...
		<main id="main">
		  ...
		  <div class="area_category">
			  <form action="" id="form_e11" method="POST" target ="hidden_iframe11" onsubmit=" submitted=true;"> 
					<div class="wow fadeIn bbackg" style="width:100%"> 
			

							 <section  id="main_intro" class="backg" style="text-align: center;z-index:0" >
							 <video playsinline autoplay loop muted id="pv" style="position:fixed;top:0;left:0;right:0;min-width: 100%; min-height: 100%;z-index:5;background-size:cover;filter:brightness(0.5)" >
							 <source src="./img/intro_vid1.mp4" type="video/mp4" >
							 </video>
							 <div class="img-text md-top3 lg-top3 top-space " style="font-size:14px;z-index:10;">
							 ...
							 <div class="container">
							  ...
							  <p>SLEEP & DIET<br></p>
							  <span class="timer " style="border:1px solid white;padding:8px 15px;font-size:13px; ">
							  접수마감 | <span id="day"></span> ( <span id="countdown1"></span>)
						  </span><br><br><br>
								 <h1  class="textleft wow fadeInUp">자면서 목표 감량하세요.<br>무료 수면 감량 분석</h3>
								<!--  <p style="text-align:left;margin-bottom:30px" class="textleft questm wow fadeIn">
								  ...
								  ">"귀중한 당신의 시간과 돈, 건강 모두를<br>잃기 쉽다는 사실 알고 계신가요?"</u></b></p> --><br>
								  ...
								  <div class="container">
									<div class="section-header" >
									 ...
									 좋은 수면이 식욕 조절과<br>체중 감량에 도움이 되는 것은 분명하다</p>
									 <p class="textleft questm">- 미국 시카고 의과대학 -</p><br><br>
									  <p class="textleft questm"><u class="underline blink">(현재 페이지 한정)</u><br>
									  </p>
									</div>
							...
							<!-- <center> <div class=" alert_msg">
							 ...
							 <center><img class="chat_img " src="./img/guide.png" ></center>
							 </div>
		
							 <div class="col-12 col50 text-center pad-msg" >
							 
							 <span class="tip-text">수면을 통해  감량 가능한 <br>최대치를 찾아 드립니다.</span><br><br>	
							 </div>
						 ...
						 <center><input name="entry.intro" id="quest00_1" class="input_font quest00 intro_click" type="radio" value="갱년기 무료 체형 분석 & 한정 이벤트" style="text-align:center;" >
						  <label class="label_button1" id="start0" for="quest00_1" onclick="go_sub();menu_remove()"><span style="font-size: 16px;"></span><span >수면 감량 분석하기</span></label>
										...
										<div class="footer-top">
										  <div class="container">
											<div class="row">
												...
												<span>회사명 : (주)에스디엘에이치 수면다이어트</span><br>
			   ...
			   <div class="member">
			  <img class="br80" src="./img/ezgif-frame-041.jpg" class="img-fluid" alt="" style="width:80%;object-fit:cover;max-width:400px" />
			  </div>
			  </div><br>
								  ...
								  <div class="col-lg-4 col-4 text-center">
									<img src="./img/gmp-ffood.png" class="gmp" style="width:100%">
						  ...
						  <img src="./img/ezgif-frame-041.jpg" class="bg-img br50" style="min-height:650px;max-height:800px">
				  ...
				  <!--메인 화면 SECTION-->
						  ...
						  <section  id="quest0_wrap" class="wow fadeIn backg container1" >
							  ...
							  <img src="./img/mirror.jpg" class="bg-img br50" style="min-height:450px;max-height:650px">
		
							  <div class="wow fadeIn quest-text ft-white" style="top:15% !important">	
						  <!--질문 문구 부분 시작-->
							  <center><h1><span class="questm ft-white">희망 목표치</span></h1></center>
						 
						  <!--질문을 띄어쓰기 하려면 '<br>'을 적으시면 됩니다-->
						  <input name="entry.1989036305" class="test_input bb-white"  type="text" pattern="[0-9]+" id="weight" style="width:40%;text-align:center;" maxlength="3" oninput="maxLengthCheck(this)" onkeyup="goal_weight()"><label class="ft-white" >kg</label><br><br>
						  <!--질문 문구 부분 끝-->
						 ...
						 <div class="footer-top">
						  ...
						  <!--질문 클릭 시 진행 방향 함수-->
							 ...
							 <!--질문 클릭 시 진행 방향 함수-->
							  ...
							  <center><input id="mf_1" name="entry.1818522882" type="radio" value="여성" /> <label class="label_button1" for="mf_1" onclick="jump_quest(5);fecheck()" >여성</label></center>
							  ...
							  <center><div class=" alert_msg">
							   ...
							   <span class="tip-text ">수면을 통해 목표 감량에<br>성공하도록 도와드립니다.</span><br><br>	
							   </div>
						  ...
						  <footer id="footer" class="section-bg" style="position:fixed;bottom:0;right:0;left:0;width:100%;margin:0;">
						  <div class="footer-top">
							<div class="container">
							  <div class="row">
									<span>*감량 효과는 개인별 차이가 있을 수 있습니다.</span><br>
							  ...
							  <div class="wow fadeIn quest-text ft-white" style="top:15% !important">	
									  ...
									  <center><h1><span class="questm ft-white">체중</span></h1></center>
		
						  <!--질문 문구 부분 시작-->
						  <input name="entry.880528237" class="test_input bb-white"  type="text"  id="now-weight" style="width:40%;text-align:center;" maxlength="3" oninput="maxLengthCheck(this)"  onkeyup="now_weight()"><label class="ft-white" >kg</label><br><br>
		<!--질문 문구 부분 끝-->
				...
				<span>주소: 서울특별시 광진구 능동로 40길 10-3</span>
							  ...
							  <!--질문2 SECTION 끝-->
								 ...
								 <div class="stepper-item"></div>
											 ...
											 <!--질문을 띄어쓰기 하려면 '<br>'을 적으시면 됩니다-->
											 <input name="entry.205668662" class="test_input bb-white"  type="text" pattern="[0-9]+" id="now-height" style="width:40%;text-align:center;" maxlength="3" oninput="maxLengthCheck(this)"  onkeyup="now_height()"><label class="ft-white" >cm</label><br><br>
											 <!--질문 문구 부분 끝-->
						 ...
						 <section  id="quest4_wrap" class="wow fadeIn backg container1" >	
						  ...
						  <div class="wow fadeIn quest-text ft-white" style="top:15% !important">	
							  <center><h1><span class="questm ft-white">나이</span></h1></center>
										 ...
										 <!--질문을 띄어쓰기 하려면 '<br>'을 적으시면 됩니다-->
										 <input name="entry.1881318671" class="test_input bb-white"  type="text"  id="now-age" style="width:30%;text-align:center;min-width: 100px;" maxlength="2" oninput="maxLengthCheck(this)"  onkeyup="now_age()"><label class="ft-white" >세</label><br><br>
										 <!--질문 문구 부분 끝-->
									  ...
									  <div class="wow fadeIn quest-text ft-white" style="top:15% !important">
										  ...
										  <center><h1><span class="questm ft-white">휴대폰 번호</span></h1></center>
													 ...
													 <center><br><div class=" alert_msg">
													  ...
													  <span class="tip-text ">전화를 통해<br>친절히 안내드리겠습니다.</span><br><br>		
													  </div>
						 ...
						 <!--나는 어떤 부모인가요?-->
									 ...
									 <section  id="quest7_wrap" class="wow fadeIn backg container1" >
									  <img src="./img/mirror.jpg" class="bg-img br50" style="min-height:700px;max-height:900px">
		
									  <div class="wow fadeIn quest-text ft-white" style="top:15% !important">
											
								  <center><h1><span class="questm ft-white">희망 감량 목표</span></h1></center><br>
							  ...
							  <center><br><div class=" alert_msg">
							   ...
							   <span class="tip-text">수면을 통해 목표 감량을<br>성공하도록 도와드립니다.</span><br><br>	
							   </div>
						...
						<!-- <img src="./img/mirror.jpg" class="bg-img br50" style="min-height:950px;max-height:1050px"> -->
   
						 <div class="wow fadeIn quest-text ft-white" style="top:15% !important">	
				
						 <center><h1 style="line-height:90%"><span class="questm ft-white">수면 다이어트<br>무료 체형 분석<br>상담 신청이 완료 되었습니다.<br><br>실질적인 도움과 안내를 위하여<br>전화를 통해 안내를 드리고 있습니다.<br>다만 부재시 감량을 도와드리지 못하니<br>꼭 전화를 받아주세요.<br><br>오로지 여러분의 건강한 감량만을 생각합니다.<br>-수면 다이어트-</span></h1></center>



						 <div class="vertical wow fadeInDown" style="height:200px;"></div>
						 ...
						 <section id="why-us" class="wow fadeIn">
												 ...
												 <div class="container" style="max-width:1200px;">
												   <div class="row counters">
													 ...
													 <p>감량 만족도</p>
													 <img src="./img/bottom_laurel.png" style="width:100%;position:relative;margin: -67px 0 0 0;max-width:200px;min-width:110px">	
													   </div>
												 ...
												 <div class="container">
													<div class="section-header">
													 <h3 style="text-align:center" class="textleft">갱년기 다이어트에 특화된<br>올바른 감량 방식을 찾아주는<br> 수면 1:1 개인 맞춤 플랜</h3>
													 <p class="textleft questm">
												   ...
												   <div class="col-lg-5 col-md-5 wow fadeInUp">
													 <div class="member">
													 <img src="./img/food.jpeg" class="img-fluid br50 imgt30" alt="" />
												   ...
												   <div class="col-lg-5 col-md-5 wow fadeInUp mgt30">
													 <div class="member">
													   ...
													   <img src="./img/schedule.jpg" class="img-fluid br50 imgt30" alt="" />
												   ...
												   <div class="row">
													 <div class="col-lg-5 col-md-5 wow fadeInUp mgt30">
													   <div class="member">
													   <img src="./img/consulting.jpg" class="img-fluid br50 imgt30" alt="" />
													 ...
													 <div class="col-lg-5 col-md-5 wow fadeInUp mgt30">
													   <div class="member">
														 ...
														 <img src="./img/managing.jpg" class="img-fluid br50 imgt30" alt="" />
											...
											<section id="team" class="section-bg wow fadeIn" style="margin-top: 30px;">
											  <div class="container">
												 <div class="section-header">
												 <h3>식약처 인증된 성분으로<br>안전하고 건강하게</h3>
												 <p class="textleft questm">     
												식약처 인증된 성분으로<br>다이어트 관리를 부담없이<br>관리할 수 있도록 도와드립니다
												 </p>
												 <img src="./img/cutncut-intro.png" style="width:100%;max-width:500px;margin-bottom:30px">
												</div>
												...
												<div class="row">
												  <div class="col-lg-5 col-md-5 wow fadeInUp ">
													<div class="member">
													  ...
													  <img class="text-gmp" src="./img/gmp-ffood.png">
													</div>
													</div>
												  </div>
												  ...
												  <div class="col-lg-5 col-md-5 wow fadeInUp ">
													<div class="member">
													  <img src="./img/garcinia.jpg" class="img-fluid br70 imgt30" alt="" />
													 <div  class="gmp"> 
													  <img src="./img/gmp-ffood.png" style="width:80px;float:left"><span>식약처 인증</span>
													 </div> 
													  <p class="img_text">수면 더블</p>
													</div>
												  </div>
												</div>
												...
												<div class="row reverse">
												  ...
												  <div class="col-lg-5 col-md-5 wow fadeInUp">
													<div class="member">
													<img src="./img/probiotics.jpg" class="img-fluid br70 imgt30" alt="" />
													<div  class="gmp"> 
													<img src="./img/gmp-ffood.png" style="width:80px;float:left"><span>식약처 인증</span>
												   </div> 
													  <p class="img_text">수면 더블</p>
												...
												<div class="row">
												  ...
												  <div class="col-lg-5 col-md-5 wow fadeInUp">
													<div class="member">
													  ...
													  <img src="./img/jiaogulan.jpg" class="img-fluid br50 imgt30" alt="" />
													  <div  class="gmp"> 
													  <img src="./img/gmp-ffood.png" style="width:80px;float:left"><span>식약처 인증</span>
													 </div> 
													  <p class="img_text">수면 돌외</p>
													</div>
												  </div>
												</div>
...
<p style="padding:17px;">갱년기 무료 체형 분석 & 한정 이벤트</p></button>
</div> -->
